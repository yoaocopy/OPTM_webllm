...
export class ExecutionVisualizer {
  ...
  render() {
    ...
    if (this.params.embeddedMode) {
      ...
      base.find('#creditsPane').html('<div style="font-size: 8pt; margin-top: 5px; margin-bottom: 5px;"><a href="http://mytutor.cs.cityu.edu.hk/opt3/" target="_blank" style="color: #3D58A2;">Python Tutor</a> by <a href="http://pgbovine.net/" target="_blank" style="color: #3D58A2;">Philip Guo</a></div>');
